...
// --- 常量配置 ---
const COURSES_DATA = [
  { id: 'c1', name: '5057 项目管理', color: 'bg-[#FCE7F3]', borderColor: 'border-pink-200', textColor: 'text-pink-500', iconColor: 'bg-pink-400', barColor: '#ec4899' }, 
  { id: 'c2', name: '5125 it研究', color: 'bg-[#E0F2FE]', borderColor: 'border-blue-200', textColor: 'text-blue-500', iconColor: 'bg-blue-400', barColor: '#3b82f6' },
  { id: 'c3', name: '5136 软件工程', color: 'bg-[#FEF9C3]', borderColor: 'border-yellow-200', textColor: 'text-yellow-600', iconColor: 'bg-yellow-400', barColor: '#ca8a04' },
  { id: 'c4', name: '5137 数据库', color: 'bg-[#DCFCE7]', borderColor: 'border-green-200', textColor: 'text-green-500', iconColor: 'bg-green-400', barColor: '#22c55e' }
];
